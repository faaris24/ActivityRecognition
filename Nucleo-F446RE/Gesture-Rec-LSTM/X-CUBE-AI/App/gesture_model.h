...
#ifndef __AI_GESTURE_MODEL_H__
#define __AI_GESTURE_MODEL_H__
#pragma once
...
#define AI_GESTURE_MODEL_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 120, 1, 6, 1, NULL), \
}
#define AI_GESTURE_MODEL_IN_SIZE { \
  (120 * 1 * 6), \
}
#define AI_GESTURE_MODEL_IN_1_SIZE  (120 * 1 * 6)
#define AI_GESTURE_MODEL_IN_1_SIZE_BYTES  ((120 * 1 * 6) * 4)
...
#define AI_GESTURE_MODEL_OUT_1_SIZE  (1 * 1 * 3)
#define AI_GESTURE_MODEL_OUT_1_SIZE_BYTES  ((1 * 1 * 3) * 4)

#define AI_GESTURE_MODEL_N_NODES (5)
